...
--------------------------------------------------------------------------------
-- Ability Start
function nastya_or:OnSpellStart()
	-- unit identifier
...
--------------------------------------------------------------------------------
-- Projectile
function nastya_or:OnProjectileHit( target, location )
	-- Apply Damage	 
	local damageTable = {
		victim = target,
...
function nastya_or:AbilityConsiderations()
	-- Scepter
