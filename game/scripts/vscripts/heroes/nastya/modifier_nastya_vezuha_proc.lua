...
--------------------------------------------------------------------------------
modifier_nastya_vezuha_proc = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_nastya_vezuha_proc:IsHidden()
	return false
end

function modifier_nastya_vezuha_proc:IsDebuff()
	return false
end

function modifier_nastya_vezuha_proc:IsStunDebuff()
	return false
end

function modifier_nastya_vezuha_proc:IsPurgable()
	return true
end

function modifier_nastya_vezuha_proc:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_nastya_vezuha_proc:OnCreated( kv )
...
function modifier_nastya_vezuha_proc:OnRefresh( kv )
	
end

function modifier_nastya_vezuha_proc:OnRemoved()
end

function modifier_nastya_vezuha_proc:OnDestroy()
end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_nastya_vezuha_proc:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_nastya_vezuha_proc:PlayEffects( value )
	value = value + 1
