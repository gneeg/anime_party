modifier_dristch_magia = class({})

function modifier_dristch_magia:OnCreated( kv )
	self.bonus = self:GetAbility():GetSpecialValueFor("bonus_resist_pct")
end

function modifier_dristch_magia:OnRefresh( kv )
	self.bonus = self:GetAbility():GetSpecialValueFor("bonus_resist_pct")
end

--------------------------------------------------------------------------------

function modifier_dristch_magia:DeclareFunctions()
	local funcs = {
...
function modifier_dristch_magia:GetModifierMagicalResistanceBonus( params )
	if not self:GetParent():PassivesDisabled() then
		return self.bonus
	end
end
function modifier_dristch_magia:GetAbsorbSpell( params )
	if IsServer() then
...
modifier_dristch_magia.reflected_spell = nil
function modifier_dristch_magia:GetReflectSpell( params )
	if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_dristch_magia:PlayEffects( bBlock )
	-- Get Resources
	local particle_cast = ""
	local sound_cast = ""
...
modifier_dristch_magia.reflect_exceptions = {
