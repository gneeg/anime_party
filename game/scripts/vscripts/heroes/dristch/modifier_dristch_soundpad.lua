modifier_dristch_soundpad = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_dristch_soundpad:IsHidden()
	return false
end

function modifier_dristch_soundpad:IsDebuff()
	return false
end

function modifier_dristch_soundpad:IsPurgable()
	return false
end

function modifier_dristch_soundpad:DestroyOnExpire()
	return false
end

function modifier_dristch_soundpad:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_dristch_soundpad:OnCreated( kv )
	-- references
...
function modifier_dristch_soundpad:OnRefresh( kv )
	
end

function modifier_dristch_soundpad:OnDestroy( kv )

end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_dristch_soundpad:OnIntervalThink()
	-- get radius
	...
	for _,enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(
			...
			"modifier_dristch_soundpad_slow", -- modifier name
