...
--------------------------------------------------------------------------------
bair_progib = class({})
LinkLuaModifier( "modifier_generic_arc_lua", "heroes/bair/modifier_generic_arc_lua", LUA_MODIFIER_MOTION_BOTH )
LinkLuaModifier( "modifier_generic_stunned_lua", "heroes/bair/modifier_generic_stunned_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Init Abilities
function bair_progib:Precache( context )
...
function bair_progib:Spawn()
	if not IsServer() then return end
end

--------------------------------------------------------------------------------
-- Ability Cast Filter
function bair_progib:CastFilterResultTarget( hTarget )
...
function bair_progib:GetCustomCastErrorTarget( hTarget )
	if self:GetCaster() == hTarget then
...
--------------------------------------------------------------------------------
-- Ability Start
function bair_progib:OnSpellStart()
	-- unit identifier
...
--------------------------------------------------------------------------------
-- Effects
function bair_progib:PlayEffects1( point, radius, allied )
	-- Get Resources
...
function bair_progib:PlayEffects2( point )
	-- Get Resources
...
function bair_progib:PlayEffects3( caster, target, duration )
	-- Get Resources
...
function bair_progib:PlayEffects4( caster )
	-- Get Resources
