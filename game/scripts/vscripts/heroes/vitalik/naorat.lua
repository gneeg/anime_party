vitalik_naorat = class({})

--------------------------------------------------------------------------------
-- Ability Start
function vitalik_naorat:OnSpellStart()
	-- unit identifier
...
--------------------------------------------------------------------------------
-- Projectile
function vitalik_naorat:OnProjectileHit( target, location )
	-- Apply Damage	 
	local damageTable = {
		victim = target,
...
function vitalik_naorat:AbilityConsiderations()
	-- Scepter
