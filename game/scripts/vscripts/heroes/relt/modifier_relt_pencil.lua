...
--------------------------------------------------------------------------------
modifier_relt_pencil = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_relt_pencil:IsHidden()
	return false
end

function modifier_relt_pencil:IsDebuff()
	return false
end

function modifier_relt_pencil:IsStunDebuff()
	return false
end

function modifier_relt_pencil:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_relt_pencil:OnCreated( kv )
	-- references
	...
	-- swap abilities
	self.caster:SwapAbilities( "relt_pencil", "relt_pencil_release", false, true )
...
function modifier_relt_pencil:OnRefresh( kv )
	
end

function modifier_relt_pencil:OnRemoved()
end

function modifier_relt_pencil:OnDestroy()
	if not IsServer() then return end
	...
	-- swap abilities
	self.caster:SwapAbilities( "relt_pencil", "relt_pencil_release", true, false )
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_relt_pencil:DeclareFunctions()
	local funcs = {
...
function modifier_relt_pencil:OnOrder( params )
...
function modifier_relt_pencil:GetModifierMoveSpeed_Limit()
	return 0.1
end

function modifier_relt_pencil:GetModifierTurnRate_Percentage()
	return -self.turn_rate
end

function modifier_relt_pencil:GetModifierDisableTurning()
	return 1
end

--------------------------------------------------------------------------------
-- Status Effects
function modifier_relt_pencil:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_relt_pencil:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Helper
function modifier_relt_pencil:SetDirection( vec )
	self.target_dir = ((vec-self.parent:GetOrigin())*Vector(1,1,0)):Normalized()
	self.face_target = false
end

function modifier_relt_pencil:TurnLogic()
...
function modifier_relt_pencil:UpdateStack()
...
--------------------------------------------------------------------------------
-- Filter
function modifier_relt_pencil:OrderFilter( data )
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_relt_pencil:PlayEffects1()
	-- Get Resources
...
function modifier_relt_pencil:PlayEffects2()
...
function modifier_relt_pencil:PlayEffects3( seconds, half )
	-- Get Resources
...
function modifier_relt_pencil:PlayEffects4( modifier )
	-- Get Resources
...
function modifier_relt_pencil:UpdateEffect()
	--NOTE: This could be a client-only code to reduce traffic, if only GetForwardVector is available on client. (Why GetAbsOrigin is available but not GetForwardVector?)
